...
const EventPage = ({
  ...
  return (
    <>
      <Pressable
        onPress={onPress}
        marginRight={isBookingComponent ? 1 : 4}
        style={[styles.shadow]}
      >
        <HStack width="100%">
          <Image
        ...
        >
          <Text fontWeight={700} fontFamily="Poppins" fontSize={14}>
            {`${title} - ${locationInfo?.city?.long_name ?? ""}`}
          </Text>
          <HStack space={1}>
            <AntDesign
              name="star"
        ...
        <View
          style={[
            styles.icon,
            isEventSaved ? { backgroundColor: colors.primary } : {},
          ]}
        >
